    ...
    <div className="relative min-h-svh overflow-hidden bg-background">
      ...
      <div className="relative mx-auto flex min-h-svh max-w-3xl flex-col items-center justify-center px-6 text-center">
        ...
        <div className="mt-8 flex items-center gap-2">
          ...
          <Link to="/" className="inline-flex items-center gap-2 rounded-lg bg-foreground px-4 py-2 text-sm font-medium text-background transition-colors hover:opacity-90">
